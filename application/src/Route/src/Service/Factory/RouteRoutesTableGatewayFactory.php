...
use Route\Model\RouteRoutesModel as Model;
...
class RouteRoutesTableGatewayFactory implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $moduleConfig = $serviceLocator->get("Route\\Routes\\Service")->getRouteConfig();
