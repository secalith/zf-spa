...
class ListAction implements ServerMiddlewareInterface, PageViewAwareInterface, TableDataAwareInterface
{
    ...
    public function process(ServerRequestInterface $request, DelegateInterface $delegate)
    {
        ...
        $data['pageData'] = $this->getTableData('pages');
...
//
        return new HtmlResponse($this->template->render('page::list', $data['pageView']));
    }
