...
return array(
    'router' => array(
        'routes' => array(
            'block_create_html' => array(
                'type'    => 'Segment',
                'options' => array(
                    'route'    => '/block/create/html/ajax/html',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Block\Controller',
                        'controller' => 'Html\Create',
                        'action'  => 'index',
                        'module' => 'block',
                        'submodule' => 'block',
                        'scenario'  => 'form',
    ...
    'controllers' => array(
        'invokables' => array(
            'Block\Controller\Html\Create' => 'Block\Controller\CreateHtmlController',
        ),
        'delegators' => array(
            'Block\Controller\CreateHtmlController' => array(
