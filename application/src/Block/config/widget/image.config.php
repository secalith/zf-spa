...
return array(
    'router' => array(
        'routes' => array(
            'block_create_image' => array(
                'type'    => 'Segment',
                'options' => array(
                    'route'    => '/block/create/image/ajax/html',
                    'defaults' => array(
    ...
    'controllers' => array(
        'invokables' => array(
            'Block\Controller\Image\Create' => 'Block\Controller\CreateImageController',
        ),
        'delegators' => array(
            'Block\Controller\CreateImageController' => array(
            ...
            'block_create_image' => [
                ...
                'elements' => [
                    [
                        'spec' => [
                            'name' => 'block_create_image',
                            'type' => 'Block\Form\Fieldset\CreateImageFoundationFieldset',
                            'options' => [
