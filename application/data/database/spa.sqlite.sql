...
INSERT INTO `user` VALUES (2,'accounts@secalith.uk','accounts','$2y$10$AcX/A1kuOuurYrppr1ecMOB3YhAab7ABMjuVmDVO6VTsiYT5AUQ96',1,'',NULL,NULL);
...
INSERT INTO `template` VALUES (NULL,'template-100','template_full','filesystem','template');
INSERT INTO `template` VALUES (NULL,'template-200','login','filesystem','auth');
INSERT INTO `template` VALUES (NULL,'template-201','user_create','filesystem','user');
...
INSERT INTO `route_routes` VALUES ('0','','/page','display','display','\Page\Action\PageAction','','route','route-route-004','route-004','page','{}','{ "bar": "baz" }');
INSERT INTO `route_routes` VALUES ('0','{''defaults'':{}}','/template/001.html','display','index','\Page\Action\PageAction','route','singlepageapplication','route-route-010','route-010','template_001','{}','{}');
INSERT INTO `route_routes` VALUES ('0','{}','/login','display','index','\Page\Action\PageAction','route','route','route-route-login','route-login','login','{}','{}');
INSERT INTO `route_routes` VALUES ('0','{}','/company','display','index','\Page\Action\PageAction','route','route','route-route-100','route-100','example_company','{}','{}');
INSERT INTO `route_routes` VALUES ('0','{}','/login/process','process','index','\Auth\Action\LoginProcessAction','route','auth','route-route-login.process','route-login.process','login_process','{}','{}');
INSERT INTO `route_routes` VALUES ('0','{}','/logout','process','index','\Auth\Action\LogoutAction','route','auth',NULL,NULL,NULL,'{}','{}');
INSERT INTO `route_routes` VALUES ('0','{}','/user/read/:uid','display','index','\User\Action\ReadAction','route','user','route-route-user.read','route-user.read','user.read','{}','{}');
...
INSERT INTO `route` VALUES ('route-100','example_company');
INSERT INTO `route` VALUES ('route-login','login');
INSERT INTO `route` VALUES ('user-create-display','user-create-display');
INSERT INTO `route` VALUES ('route-login.process','login_process');
INSERT INTO `route` VALUES ('route-logout','logout');
INSERT INTO `route` VALUES ('route-user.read','user.read');
...
INSERT INTO `page` VALUES ('1','/company','page-100','example_company','template-100','route-100');
INSERT INTO `page` VALUES ('0','/login','page-login','login','template-200','route-login');
INSERT INTO `page` VALUES ('0','/user/list','page-user.list','user.list','template-001','route-user.list');
INSERT INTO `page` VALUES ('0','/user/create','page-user.create','user.create','template-201','route-user.create');
INSERT INTO `page` VALUES ('0','/login/process','page-login.process','login_process','template-001','route-login.process');
INSERT INTO `page` VALUES ('0','/logout','page-logout','logout',NULL,'route-logout');
INSERT INTO `page` VALUES ('0','/user/read/:uid','page-user.read','user.read','template-001','route-user.read');
...
INSERT INTO `menu_item` VALUES (2,'/en/',1,'English','menu-001','menu_item_002');
INSERT INTO `menu_item` VALUES (1,'/homepage',1,'Homepage','menu-002','menu_item_003');
INSERT INTO `menu_item` VALUES (2,'/journal',1,'Journal','menu-002','menu_item_004');
INSERT INTO `menu_item` VALUES (3,'/video',1,'Video','menu-002','menu_item_005');
INSERT INTO `menu_item` VALUES (4,'/news',1,'News','menu-002','menu_item_006');
INSERT INTO `menu_item` VALUES (5,'/conferences',1,'Conferences','menu-002','menu_item_007');
INSERT INTO `menu_item` VALUES (6,'/e-learning',1,'E-Learning','menu-002','menu_item_008');
INSERT INTO `menu_item` VALUES (7,'/projects',1,'Projects','menu-002','menu_item_009');
INSERT INTO `menu_item` VALUES (8,'/search',1,'Search','menu-002','menu_item_010');
INSERT INTO `menu_item` VALUES (3,'/login/',1,'<span style="color:#ccf131" class="glyphicon glyphicon-user" aria-hidden="true"></span>','menu-001','menu_item_011');
...
INSERT INTO `form` VALUES ('form-003','login','{"action":"/login/process"}','{}','{}');
INSERT INTO `form` VALUES ('form-004','user_create','{"action":"/user/create/process"}','{}','{}');
...
INSERT INTO `content` VALUES ('content-026','block-016',1,'template-001','text','{}','{"html_tag":"a"}','{"wrapper":{"outer":{"parameters":{"html_tag":"h2"} }}}','[::content:content-027::] Advanced Forms','0');
...
INSERT INTO `content` VALUES ('content-037','block-021',2,'template-001','text','{}','{"html_tag":"p"}','{}','Our Single Page Application hs built-in email sender application which allows you to edit email templates!<br />
...
INSERT INTO `content` VALUES ('content-041','block-021',1,'template-001','text','{"href":"https://docs.zendframework.com/zend-view/","target":"_blank"}','{"html_tag":"a"}','{"wrapper":{"outer":{"parameters":{"html_tag":"p"} }}}','Read more about the Email Queue Application.','0');
INSERT INTO `content` VALUES ('content-042','block-030',1,'template-001','text','{}','{"html_tag":"hr"}','{}',' ','0');
INSERT INTO `content` VALUES ('content-043','block-030',2,'template-001','text','{}','{"html_tag":"p"}','{}','© Secalith Ltd ; company@secalith.uk ; 01179773002','0');
...
INSERT INTO `content` VALUES ('content-051','block-033',1,'template-200','text','{}','{"html_tag":"h2"}','{}','Login','0');
INSERT INTO `content` VALUES ('content-052','block-033',3,'template-200','text','{}','{}','{}','Or use the one of the services:','0');
INSERT INTO `content` VALUES ('content-060','block-050',1,'template-001','text','{"href":"/login"}','{"html_tag":"a"}','{"wrapper":{"outer":{"parameters":{"html_tag":"li"}}}}','Login','0');
INSERT INTO `content` VALUES ('content-061','block-050',2,'template-001','text','{"href":"/logout"}','{"html_tag":"a"}','{"wrapper":{"outer":{"parameters":{"html_tag":"li"}}}}','Logout','0');
INSERT INTO `content` VALUES ('content-062','block-050',3,'template-001','text','{"href":"[::{\"url\":{\"page.update\":{\"url\":\"uid\"}}}::]"}','{"html_tag":"a"}','{"wrapper":{"outer":{"parameters":{"html_tag":"li"}}}}','Edit this Page','0');
INSERT INTO `content` VALUES ('content-063','block-050',4,'template-001','text','{"href":"[::{\"url\":\"page.list\"}::]"}','{"html_tag":"a"}','{"wrapper":{"outer":{"parameters":{"html_tag":"li"}}}}','Pages','0');
INSERT INTO `content` VALUES ('content-064','block-050',5,'template-001','text','{"href":"[::{\"url\":\"user.list\"}::]"}','{"html_tag":"a"}','{"wrapper":{"outer":{"parameters":{"html_tag":"li"}}}}','Users','0');
INSERT INTO `content` VALUES ('content-065','block-050',6,'template-001','text','{"href":"[::{\"url\":\"user.account\"}::]"}','{"html_tag":"a"}','{"wrapper":{"outer":{"parameters":{"html_tag":"li"}}}}','Logged in as <strong>[::viewHelper:getIdentity::]</strong>','0');
...
INSERT INTO `block_form` VALUES (5,'block-034','form-004','\User\Form\CreateForm','[::url:user.create.process::]');
CREATE TABLE block (
    "uid" TEXT,
    "area" TEXT,
    "attributes" TEXT DEFAULT ('{}'),
...
INSERT INTO `block` VALUES ('block-032','area-0091','{}','{}','{}','app::navigation::simple',NULL,1,'sk','0',' ');
INSERT INTO `block` VALUES ('block-033','area-200','{}','{}','{}','form::fqdn','template-200',1,'ssa','0','[::content:content-051::][::form:form-003::][::content:content-052::]');
INSERT INTO `block` VALUES ('block-034','area-201','{}','{}','{}','form::fqdn','template-201',NULL,NULL,'0',' ');
INSERT INTO `block` VALUES ('block-050','area-009','{"class":"nav navbar-nav navbar-right"}','{"html_tag":"ul"}','{}','block::list','template-001',3,'dye','0',' ');
CREATE TABLE "area" (
  "uid" text NULL,
  "template" text NULL,
...
INSERT INTO `area` VALUES ('area-200','template-200','content_main','{}','{}','{}','page');
INSERT INTO `area` VALUES ('area-201','template-201','content_main','{}','{}','{}','page');
CREATE TABLE acl
(
